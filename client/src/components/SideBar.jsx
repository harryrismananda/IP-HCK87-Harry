...
export const SideBar = ({ onClose }) => {
  ...
  return (
    <div className={`h-screen w-64 lg:w-72 bg-base-200 text-base-content flex flex-col shadow-lg ${onClose ? 'fixed' : 'sticky top-0'}`}>
      {/* Mobile close button */}
      {onClose && (
        <div className="lg:hidden p-4 border-b border-base-300 flex-shrink-0">
          <button 
      ...
      <div className="p-4 text-lg lg:text-xl font-bold text-primary border-b border-base-300 flex-shrink-0">
        CMS Dashboard
      </div>
